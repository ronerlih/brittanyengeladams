let WEBSITE_DATA = [
		...
		blurb: "Hand Dance' is a dance film and collaboration of composer David Lang, choreographer Annie-B Parson, visual artist Ron Erlih, and dancer and choreographer Brittany Engel-Adams. Moved by their premiere date, the eve of election 2020, they wished to make something reflecting this precipice, ",
...
// 	},
		...
		img: "images/mesh.png", 
		blurb: "‘Memory Dance’ uses open source library (OpenNI), OpenNI’s algorithms create a diagram of the body, and finds a mathematical pattern and connection between the spatial input and a human pose. Then makes a prediction of the body’s position in space, and renders a skeletal avatar in the space mirroring the human position.",
		link: "",
		credit:"",
	},
