let WEBSITE_DATA = [	
	...
	
	{
		...
		blurb: "Explores the construct and material of the digital identity (avatar) as mapped to the body and (pre)conditioned by history and culture. Brittany Engel-Adams uses data visualization and hacked kinect technology to sync, record and loop a series of gestures that memories itself (avatar). ",
