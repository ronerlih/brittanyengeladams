let WEBSITE_DATA = [	
	...
	
	{
		...
		blurb: "Explores the construct and the materiality of the digital identification (avatar) as mapped to the body and (pre)conditioned by history and culture. Brittany Engel-Adams uses data visualization techniques and Hacked Kinect technology to sync, record and loop a series of gestures that memories itself. ",
